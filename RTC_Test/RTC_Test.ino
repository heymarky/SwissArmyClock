...
Serial.println(" * p - toggle scrolling time printout (pause)");
Serial.println(" * T(00-59)(00-59)(00-23)(1-7)(01-31)(01-12)(00-99) - T(sec)(min)(hour)(dayOfWeek)(dayOfMonth)(month)(year) -");
Serial.println(" * T - Sets the date of the RTC DS1307 Chip. ");
Serial.println(" * Example to set the time for 25-Jan-2012 @ 19:57:11 for the 4 day of the week, use this command - T1157194250112");
Serial.println(" * Q(1-2) - (Q1) Memory initialization  (Q2) RTC - Memory Dump  ");
Serial.println(" * R - Read/display the time, day and date");
}
